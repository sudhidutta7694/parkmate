...
export type CreateBookingTimelineMutation = { __typename?: 'Mutation', createBookingTimeline: { __typename?: 'BookingTimeline', bookingId: number, id: number, managerId: string, status: BookingStatus, timestamp: any } };
