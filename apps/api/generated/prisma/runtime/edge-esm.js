    ...
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of ca(t))
        !ma.call(e, i) &&
          ...
          tn(e, i, {
            get: () => t[i],
            enumerable: !(n = ua(t, i)) || n.enumerable,
          })
    return e
  }
var Qe = (e, t, r) => (
...
var bi = Fe((Ke) => {
  ...
  var si = (e, t) => () => (
    ...
    fa = si((e) => {
      ...
      function g(C) {
        ...
        return (
          B === 2 &&
            ((R = (r[C.charCodeAt(G)] << 2) | (r[C.charCodeAt(G + 1)] >> 4)),
            (k[F++] = R & 255)),
          B === 1 &&
            ((R =
              (r[C.charCodeAt(G)] << 10) |
              (r[C.charCodeAt(G + 1)] << 4) |
              (r[C.charCodeAt(G + 2)] >> 2)),
            (k[F++] = (R >> 8) & 255),
            (k[F++] = R & 255)),
          k
        )
      ...
      function S(C) {
        for (
          var R, D = C.length, M = D % 3, B = [], k = 16383, F = 0, ie = D - M;
          F < ie;
          F += k
        )
          B.push(v(C, F, F + k > ie ? ie : F + k))
        return (
          M === 1
            ? ((R = C[D - 1]), B.push(t[R >> 2] + t[(R << 4) & 63] + '=='))
            : M === 2 &&
              ((R = (C[D - 2] << 8) + C[D - 1]),
  ...
  function ba(e) {
    ...
    if (e.length !== void 0)
      return typeof e.length != 'number' || un(e.length) ? be(0) : nn(e)
  ...
  function Ca(e, t, r, n) {
    return ar(La(t), e, r, n)
  }
  function Aa(e, t, r, n) {
    return ar(Ei(t), e, r, n)
  }
  function Ra(e, t, r, n) {
    return ar(Ba(t, e.length - r), e, r, n)
  }
  ...
  function ka(e) {
    ...
    let r = '',
      n = 0
    for (; n < t; )
      r += String.fromCharCode.apply(String, e.slice(n, (n += ii)))
    return r
  }
  function Ia(e, t, r) {
    let n = ''
...
var eo = Fe((Qd, Xi) => {
  ...
  m()
  var El = Zi()
  Xi.exports = (e) => (typeof e == 'string' ? e.replace(El(), '') : e)
})
var vn = Fe((_y, Eo) => {
  'use strict'
  d()
    ...
    return function (t, r) {
      ...
      for (; a < o; )
        for (D = r.charCodeAt(s + (f = a)), S = ++a, l = 0; l < ie; l += 2)
          (C = F[l]), (F[l] = S = e(C, f, S, D, F[l + 1])), (f = C)
      return S
    }
  })()
})
...
var $a = {
  enabled:
    !Ai && Ri == null && Si !== 'dumb' && ((cn != null && cn !== '0') || ki),
}
function j(e, t) {
...
var Y = new Proxy(Ga, { get: (e, t) => xt[t], set: (e, t, r) => (xt[t] = r) })
function Qa(e, t = 2) {
  let r = new Set()
...
A.minus = A.sub = function (e) {
  ...
  if (
    ((f = S.d), (v = e.d), (a = C.precision), (l = C.rounding), !f[0] || !v[0])
  ) {
    if (v[0]) e.s = -e.s
    else if (f[0]) e = new C(S)
...
A.toPower = A.pow = function (e) {
  ...
  if (((t = Z(e.e / O)), t >= e.d.length - 1 && (r = f < 0 ? -f : f) <= vl))
...
var q = (function () {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (S == 1) (M.e = g), (so = C)
      ...
      ;(M.e = h + g * S - 1), I(M, a ? o + M.e + 1 : o, s, C)
    }
    return M
  }
})()
...
function Er(e, t, r) {
  if (t > Tl) throw ((_ = !0), r && (e.precision = r), Error(ao))
...
function ke(e, t) {
  ...
  if (
    ...
    return (
      ...
      (R = ke(new M(n + '.' + r.slice(1)), g - C).plus(f)),
      (M.precision = k),
...
m()
var Tr = {}
or(Tr, { ModelAction: () => Rt, datamodelEnumToSchemaEnum: () => hu })
d()
u()
c()
p()
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...
          argument: {
            ...n.argument,
            typeNames: Tu(o.argument.typeNames, n.argument.typeNames),
          },
        })
      : t.set(i, n)
  }
...
function _u(e, t) {
  ...
  n && (n.getField(r)?.markAsError(), Gu(n, e.arguments)),
    t.addErrorMessage((i) =>
      So(
        i,
        r,
...
function On({
  ...
  return { modelName: e, action: Yu[t], query: Lt(r, h) }
}
...
function Vo(e, t) {
  ...
  if (ic(e)) return e.values
  if (rt(e)) return { $type: 'Decimal', value: e.toFixed() }
  if (e instanceof Te) {
    if (e !== An.instances[e._getName()])
      throw new Error('Invalid ObjectEnumValue')
    return { $type: 'Enum', value: e._getName() }
  }
  if (oc(e)) return e.toJSON()
...
function wc(e = {}) {
  return typeof e.select == 'object'
    ? (t) => Gr(e)(t)._count
    : (t) => Gr(e)(t)._count._all
}
function ts(e, t) {
  return t({ action: 'count', unpacker: wc(e), argsMapper: yc })(e)
}
d()
u()
c()
...
function rs(e, t) {
  return t({ action: 'groupBy', unpacker: bc(e), argsMapper: Ec })(e)
}
function ns(e, t, r) {
...
function Ac(e, t) {
  ...
  return {
    ...
    getPropertyValue(i) {
      ...
      return Tc.includes(o) ? Ln(e, t, s) : Rc(i) ? ns(e, i, s) : s({})
    },
  }
}
function Rc(e) {
...
function cs({ result: e, modelName: t, select: r, omit: n, extensions: i }) {
  ...
  for (let l of Object.values(o)) {
    ...
    Oc(e, l.needs) && s.push(Dc(l, pe(e, s)))
  }
...
var Mc = ['$connect', '$disconnect', '$on', '$transaction', '$use', '$extends'],
  ds = Mc
function fs(e) {
  if (e instanceof le) return _c(e)
  if (Br(e)) return Nc(e)
  if (Array.isArray(e)) {
    let r = [e[0]]
...
p()
m()
var Fc = () => globalThis.process?.release?.name === 'node',
  Lc = () => !!globalThis.Bun || !!globalThis.process?.versions?.bun,
  Bc = () => !!globalThis.Deno,
  Uc = () => typeof globalThis.Netlify == 'object',
  qc = () => typeof globalThis.EdgeRuntime == 'object',
  $c = () => globalThis.navigator?.userAgent === 'Cloudflare-Workers'
function jc() {
  return (
    [
      [Uc, 'netlify'],
...
p()
m()
var Qc = 'Interactive transaction error',
  Ht = class extends V {
...
p()
m()
var Jc = 'Request parameters are invalid',
  Kt = class extends V {
...
async function Yc(e, t) {
  ...
  let [i, o] = n?.split('-') ?? []
  if (o === void 0 && zc.test(i)) return i
  if (o !== void 0 || n === '0.0.0' || n === 'in-memory') {
    ...
    try {
      ...
      throw (
        (console.error('JSON.parse error: body fetched from unpkg.com: ', v), C)
      )
    }
    return S.version
  }
...
p()
m()
function Ms({ url: e, adapter: t, copyEngine: r, targetBuildType: n }) {
  let i = [],
    o = [],
    s = (R) => {
...
`)
  ...
  let S = { accelerate: v, ppg: f, driverAdapters: g }
  function C(R) {
    return R.length > 0
  }
  return C(o)
    ? { ok: !1, diagnostics: { warnings: i, errors: o }, isUsing: S }
    : { ok: !0, diagnostics: { warnings: i }, isUsing: S }
}
function _s({ copyEngine: e = !0 }, t) {
  let r
  try {
    r = mt({
  ...
  let {
    ...
    isUsing: i,
    diagnostics: o,
  } = Ms({ url: r, adapter: t.adapter, copyEngine: e, targetBuildType: 'edge' })
  for (let g of o.warnings) fr(...g.value)
  if (!n) {
    let g = o.errors[0]
    throw new X(g.value, { clientVersion: t.clientVersion })
  }
  let s = Ye(t.generator),
    a = s === 'library',
    l = s === 'binary',
    f = s === 'client'
  return i.accelerate ? new ht(t) : (i.driverAdapters, i.accelerate, new ht(t))
}
d()
u()
c()
...
function Ls(e, t) {
  return JSON.stringify(e.map((r) => Us(r, t)))
}
function Us(e, t) {
  if (Array.isArray(e)) return e.map((r) => Us(r, t))
  if (typeof e == 'bigint')
...
function Yn(e) {
  return function (r, n) {
    let i,
      o = (s = e) => {
        try {
          return s === void 0 || s?.kind === 'itx' ? (i ??= Gs(r(s))) : Gs(r(s))
        } catch (a) {
...
var tp = mn.split('.')[0],
  ...
  Zn = class {
    ...
    getGlobalTracingHelper() {
      let t = globalThis[`V${tp}_PRISMA_INSTRUMENTATION`],
        r = globalThis.PRISMA_INSTRUMENTATION
      return t?.helper ?? r?.helper ?? rp
    }
  }
function Qs() {
  return new Zn()
...
var op = Y('prisma:client:request_handler'),
  Yr = class {
    client
    dataloader
    logEmitter
...
function Ys(e) {
  if (e.kind === 'Union') return { kind: 'Union', errors: e.errors.map(Ys) }
...
var Xs = [
  ...
  ea = ['pretty', 'colorless', 'minimal'],
  ta = ['info', 'query', 'warn', 'error'],
  up = {
...
Expected string or undefined.`)
    ...
    omit: (e, t) => {
      ...
      if (r.length > 0) throw new U(mp(e, r))
    },
    __internal: (e) => {
      if (!e) return
...
function hp(e) {
  class t {
    ...
    constructor(n) {
      ;(e = n?.__internal?.configOverride?.(e) ?? e), vs(e), n && ia(n, e)
        ...
        if (
          ...
          (this._accelerateEngineConfig = {
            ...
            accelerateUtils: {
              ...
              engineVersion: aa.version,
              clientVersion: e.clientVersion,
            },
          }),
          Ne('clientVersion', e.clientVersion),
          (this._engine = _s(e, this._engineConfig)),
          ...
          for (let S of l.log) {
            ...
            C &&
              this.$on(C, (R) => {
                vt.log(`${vt.tags[C] ?? ''}`, R.message || R.query)
              })
          }
      } catch (l) {
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? dp,
        o = {
...
function sa(e, t) {
  return yp(e) ? [new le(e, t), js] : [e, Vs]
}
function yp(e) {
...
export {
  ...
  le as Sql,
  zu as createParam,
  sc as defineDmmfProperty,
  Ct as deserializeJsonResponse,
  ti as deserializeRawResult,
  gu as dmmfToRuntimeDataModel,
  pc as empty,
  hp as getPrismaClient,
  qn as getRuntime,
  cc as join,
  Ep as makeStrictEnum,
  lc as makeTypedQueryFactory,
