...
var Pi = Ae((rt) => {
  ...
  var li = (e, t) => () => (
    ...
    Ca = li((e) => {
      ...
      function R(C) {
        for (
          var A, O = C.length, M = O % 3, L = [], k = 16383, N = 0, z = O - M;
          N < z;
          N += k
        )
  ...
  function Ia(e) {
    ...
    if (e.length !== void 0)
      return typeof e.length != 'number' || sn(e.length) ? Re(0) : en(e)
  ...
  function La(e, t, r, n) {
    return nr(tn(t, e.length - r), e, r, n)
  }
  function Da(e, t, r, n) {
...
var wn = Ae((Rf, zi) => {
  ...
  m()
  var Jl = Hi()
  zi.exports = (e) => (typeof e == 'string' ? e.replace(Jl(), '') : e)
})
var Yi = Ae((Xf, ar) => {
  'use strict'
  f()
      ...
      for (var z = N.length - 1; a < o - 3; )
        for (
          ...
          (C = N[l]),
            ...
            (u = C)
      for (; a < o; )
        for (O = r.charCodeAt(s + (u = a)), R = ++a, l = 0; l < z; l += 2)
          (C = N[l]), (N[l] = R = e(C, u, R, O, N[l + 1])), (u = C)
      return R
    }
  })()
})
...
m()
var an = {}
Ze(an, { defineExtension: () => vi, getExtensionContext: () => Ti })
f()
c()
p()
d()
...
var Oi = {
  enabled:
    !Ai && Si == null && Ri !== 'dumb' && ((un != null && un !== '0') || ki),
}
function U(e, t) {
...
var K = new Proxy(yl, { get: (e, t) => It[t], set: (e, t, r) => (It[t] = r) })
function wl(e, t = 2) {
  let r = new Set()
...
S.dividedToIntegerBy = S.divToInt = function (e) {
  var t = this,
    r = t.constructor
  return I(j(t, new r(e), 0, 1, 1), r.precision, r.rounding)
}
...
S.inverseTangent = S.atan = function () {
  ...
  if (u.isFinite()) {
    ...
    if (h + 4 <= Tn) return (s = ye(g, h + 4, v).times(0.5)), (s.s = u.s), s
  }
  for (
    g.precision = a = h + 10,
      g.rounding = 1,
...
S.plus = S.add = function (e) {
  ...
  return (e.d = u), (e.e = fr(u, n)), _ ? I(e, a, l) : e
}
...
S.toNearest = function (e, t) {
  ...
  return (
    e.d[0]
      ? ((_ = !1), (r = j(r, e, 0, t, 1).times(e)), (_ = !0), I(r))
      : ((e.s = r.s), (r = e)),
    r
  )
}
...
S.toPower = S.pow = function (e) {
  ...
  if (((t = te(e.e / F)), t >= e.d.length - 1 && (r = u < 0 ? -u : u) <= zl))
    return (i = uo(l, a, r, n)), e.s < 0 ? new l(1).div(i) : I(i, n, o)
  if (((s = a.s), s < 0)) {
  ...
  return (
    ...
    t > l.maxE + 1 || t < l.minE - 1
      ...
      : ((_ = !1),
        ...
        (i = Cn(e.times(Ne(a, n + r)), n)),
        i.d &&
          ((i = I(i, n + 5, 1)),
          Lt(i.d, n, o) &&
            ((t = n + 10),
            (i = I(Cn(e.times(Ne(a, t + r)), t), t + 5, 1)),
...
function Y(e) {
  ...
  if (i > 0) {
    for (o += s, t = 1; t < i; t++)
      (n = e[t] + ''), (r = F - n.length), r && (o += De(r)), (o += n)
    ;(s = e[t]), (n = s + ''), (r = F - n.length), r && (o += De(r))
...
var j = (function () {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (R == 1) (M.e = g), (no = C)
      ...
      ;(M.e = h + g * R - 1), I(M, a ? o + M.e + 1 : o, s, C)
    }
    return M
  }
})()
...
function dr(e, t, r) {
  if (t > Yl) throw ((_ = !0), r && (e.precision = r), Error(io))
  return I(new e(cr), t, 1, !0)
}
function ye(e, t, r) {
  if (t > Tn) throw Error(io)
  ...
  for (
    ...
    if (
      ...
      if (t == null)
        ...
        else return I(s, (v.precision = C), R, (_ = !0))
...
function Ne(e, t) {
  ...
  if (A.s < 0 || !O || !O[0] || (!A.e && O[0] == 1 && O.length == 1))
    return new M(O && !O[0] ? -1 / 0 : A.s != 1 ? NaN : O ? 0 : A)
  if (
    (t == null ? ((_ = !1), (g = k)) : (g = t),
    (M.precision = g += C),
    (r = Y(O)),
    ...
    return (
      (u = dr(M, g + 2, k).times(o + '')),
      (A = Ne(new M(n + '.' + r.slice(1)), g - C).plus(u)),
      (M.precision = k),
      t == null ? I(A, k, L, (_ = !0)) : A
    )
  for (
    h = A,
    ...
    if (
      ((s = I(s.times(v), g, 1)),
      (u = l.plus(j(s, new M(i), g, 1))),
      Y(u.d).slice(0, g) === Y(l.d).slice(0, g))
    )
      if (
        ((l = l.times(2)),
        o !== 0 && (l = l.plus(dr(M, g + 2, k).times(o + ''))),
        (l = j(l, new M(R), g, 1)),
        t == null)
      )
        if (Lt(l.d, g - C, L, a))
          (M.precision = g += C),
            ...
            (v = I(A.times(A), g, 1)),
            (i = a = 1)
        else return I(l, (M.precision = k), L, (_ = !0))
...
m()
var Nt = {}
Ze(Nt, { ModelAction: () => ct, datamodelEnumToSchemaEnum: () => Uu })
f()
c()
p()
d()
...
var Vu = (e) => e,
  ...
  D = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++Qu }), e.__id
        )
      },
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...
          argument: {
            ...n.argument,
            typeNames: rc(o.argument.typeNames, n.argument.typeNames),
          },
        })
      : t.set(i, n)
  }
...
function dc(e, t) {
  ...
  n && (n.getField(r)?.markAsError(), Pc(n, e.arguments)),
    t.addErrorMessage((i) =>
      Oo(
        i,
        r,
...
function Wt({ select: e, include: t, ...r } = {}, n) {
  let i = r.omit
  return delete r.omit, { arguments: Wo(r, n), selection: kc(e, t, i, n) }
}
function kc(e, t, r, n) {
  return e
    ? (t
...
`)
  return t.reduce(function (r, n) {
    var i = Qc(n) || Jc(n) || Hc(n) || Xc(n) || Yc(n)
    return i && r.push(i), r
  }, [])
}
var Uc =
...
var Wc =
  ...
  Kc = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i
function Hc(e) {
  var t = Wc.exec(e)
  if (!t) return null
...
var ps = (e) => (Array.isArray(e) ? e : e.split('.')),
  Bn = (e, t) => ps(t).reduce((r, n) => r && r[n], e),
  ds = (e, t, r) =>
    ps(t).reduceRight(
...
function pp(e, t) {
  ...
  return {
    ...
    getPropertyValue(i) {
      ...
      return up.includes(o) ? Un(e, t, s) : dp(i) ? us(e, i, s) : s({})
    },
  }
}
function dp(e) {
...
function hs({ result: e, modelName: t, select: r, omit: n, extensions: i }) {
  ...
  for (let l of Object.values(o)) {
    ...
    hp(e, l.needs) && s.push(yp(l, fe(e, s)))
  }
...
d()
m()
var wp = ['$connect', '$disconnect', '$on', '$transaction', '$use', '$extends'],
  bs = wp
function Es(e) {
  if (e instanceof ae) return bp(e)
  if (Lr(e)) return Ep(e)
  if (Array.isArray(e)) {
    let r = [e[0]]
...
function Zt(e) {
  if (typeof e != 'object' || e == null || e instanceof Me || gt(e)) return e
...
d()
m()
var xp = () => globalThis.process?.release?.name === 'node',
  Pp = () => !!globalThis.Bun || !!globalThis.process?.versions?.bun,
  vp = () => !!globalThis.Deno,
  Tp = () => typeof globalThis.Netlify == 'object',
  Cp = () => typeof globalThis.EdgeRuntime == 'object',
  Ap = () => globalThis.navigator?.userAgent === 'Cloudflare-Workers'
function Sp() {
  return (
    [
      [Tp, 'netlify'],
...
\`\`\``
      : '',
    g = (0,
    Gn.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
var Qr = (e, t = new Wn()) => {
    let r = {
      ...
      startTransaction: async (...n) =>
        (await _e(t, e.startTransaction.bind(e))(...n)).map((o) => kp(t, o)),
    }
    return (
      e.getConnectionInfo &&
        (r.getConnectionInfo = Op(t, e.getConnectionInfo.bind(e))),
      r
    )
  },
  kp = (e, t) => ({
...
function _e(e, t) {
  return async (...r) => {
    try {
      ...
      if ((Ns('[error@wrapAsync]', n), Jn(n))) return He(n.cause)
...
function Op(e, t) {
  return (...r) => {
    try {
      ...
      if ((Ns('[error@wrapSync]', n), Jn(n))) return He(n.cause)
      let i = e.registerNewError(n)
      return He({ kind: 'GenericJs', id: i })
    }
  }
...
var X2 = [...dn, 'native'],
  Lp = 0xffffffffffffffffn,
  Hn = 1n
function Dp() {
  let e = Hn++
  return Hn > Lp && (Hn = 1n), e
}
var Xt = class {
  name = 'LibraryEngine'
  engine
  ...
  async loadEngine() {
    if (!this.engine) {
      ...
      try {
        let t = new b(this)
        this.adapterPromise ||
          (this.adapterPromise = this.config.adapter?.connect()?.then(Qr))
...
d()
m()
function Bs({ url: e, adapter: t, copyEngine: r, targetBuildType: n }) {
  let i = [],
    o = [],
    s = (A) => {
      i.push({ _tag: 'warning', value: A })
    },
    a = (A) => {
      let O = A.join(`
`)
      o.push({ _tag: 'error', value: O })
    },
  ...
  let R = { accelerate: v, ppg: u, driverAdapters: g }
  function C(A) {
    return A.length > 0
  }
  return C(o)
...
function Us({ copyEngine: e = !0 }, t) {
  ...
  for (let g of o.warnings) _t(...g.value)
  if (!n) {
    let g = o.errors[0]
    throw new ee(g.value, { clientVersion: t.clientVersion })
  }
  let s = nt(t.generator),
    a = s === 'library',
    l = s === 'binary',
    u = s === 'client'
  return new Xt(t)
...
function Gs(e, t) {
  return JSON.stringify(e.map((r) => Ws(r, t)))
}
function Ws(e, t) {
  if (Array.isArray(e)) return e.map((r) => Ws(r, t))
  if (typeof e == 'bigint')
...
var jp = fn.split('.')[0],
  ...
  ei = class {
    ...
    getGlobalTracingHelper() {
      let t = globalThis[`V${jp}_PRISMA_INSTRUMENTATION`],
...
var Qp = K('prisma:client:request_handler'),
  Yr = class {
    client
    dataloader
    logEmitter
      ...
      ;(this.logEmitter = r),
        ...
        (this.dataloader = new Hr({
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === 'itx' ? ia(n.transaction) : void 0,
    ...
    handleRequestError({
      ...
      if ((Qp(t), Jp(t, i))) throw t
      if (t instanceof oe && Wp(t)) {
        let u = oa(t.meta)
        kr({
          args: o,
          errors: [u],
...
function Gp(e) {
  if (e) {
    ...
    if (e.kind === 'itx') return { kind: 'itx', options: ia(e) }
...
function oa(e) {
  if (e.kind === 'Union') return { kind: 'Union', errors: e.errors.map(oa) }
...
Expected string or undefined.`)
    ...
    omit: (e, t) => {
      ...
      if (r.length > 0) throw new q(Yp(e, r))
    },
    __internal: (e) => {
      if (!e) return
...
function ha(e) {
  class t {
    ...
    constructor(n) {
      ;(e = n?.__internal?.configOverride?.(e) ?? e), ks(e), n && da(n, e)
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? Zp,
        o = {
...
function fa(e, t) {
  return td(e) ? [new ae(e, t), zs] : [e, Ys]
}
function td(e) {
...
function ya(e) {
  return new Proxy(e, {
    get(t, r) {
      ...
      if (!rd.has(r)) throw new TypeError(`Invalid enum value: ${String(r)}`)
    },
  })
}
f()
