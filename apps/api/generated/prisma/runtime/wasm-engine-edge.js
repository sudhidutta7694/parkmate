      ...
      A[Symbol.for('nodejs.util.inspect.custom')] =
        function () {
          var t = this,
            e = $(t),
            r = t.constructor
          return Ie(t, e <= r.toExpNeg || e >= r.toExpPos)
        }
    he = (function () {
      function t(n, i) {
        var o,
...
var Xr = Symbol()
function Tt(t) {
  let e = [nl(t), il(t), K(Xr, () => t), K('$parent', () => t._appliedParent)],
...
`)
  ...
  let R = { accelerate: k, ppg: h, driverAdapters: T }
  function O(S) {
    return S.length > 0
  }
  return O(o)
...
function wo({ copyEngine: t = !0 }, e) {
  ...
  for (let T of o.warnings) lt(...T.value)
  if (!n) {
    let T = o.errors[0]
    throw new W(T.value, { clientVersion: e.clientVersion })
  }
  let s = Ue(e.generator),
    a = s === 'library',
    f = s === 'binary',
    h = s === 'client'
...
var kl = Ir.split('.')[0],
  ...
  an = class {
    ...
    getGlobalTracingHelper() {
      let e = globalThis[`V${kl}_PRISMA_INSTRUMENTATION`],
      ...
      ;(this.logEmitter = r),
        ...
        (this.dataloader = new hr({
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === 'itx' ? Lo(n.transaction) : void 0,
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? $l,
        ...
        f = async (h) => {
          ...
          let { runInTransaction: C, args: k, ...R } = h,
            O = { ...n, ...R }
