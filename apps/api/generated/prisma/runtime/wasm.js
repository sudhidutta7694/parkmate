...
function it(t, e) {
  ...
  for (
    ...
    if (
      ...
      ce(f.d).slice(0, h) === ce(a.d).slice(0, h))
    )
      return (
        (a = a.times(2)),
    ...
    R.toSignificantDigits = R.tosd = function (t, e) {
      ...
      return (
        t === void 0
          ...
          : (me(t, 1, Fe), e === void 0 ? (e = n.rounding) : me(e, 0, 8)),
        _(new n(r), t, e)
      )
    }
    R.toString =
...
var _i = Le((oP, qa) => {
  qa.exports = {
    ...
    license: 'Apache-2.0',
    author: 'Tim Suchanek <suchanek@prisma.io>',
    prisma: { enginesVersion: '2060c79ba17c6bb9f5823312b6f6b7f4a845738e' },
    repository: {
      type: 'git',
