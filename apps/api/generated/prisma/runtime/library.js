...
var k = (e, r, t) => (
    ...
    _o(
      r || !e || !e.__esModule
        ? Vt(t, 'default', { value: e, enumerable: !0 })
        : t,
      e,
    )
  ),
  Tu = (e) => _o(Vt({}, '__esModule', { value: !0 }), e)
var gi = ne((Ng, ss) => {
  'use strict'
...
`,
  ...
  function dp(e) {
    let r = Li.resolve(process.cwd(), '.env'),
      t = 'utf8',
      n = !!(e && e.debug)
    e && e.encoding
      ? (t = e.encoding)
  ...
  ia.exports = (function () {
    ...
    return function (r, t) {
      ...
      for (var me = D.length - 1; a < o - 3; )
        for (
          S = t.charCodeAt(s + (u = a)),
            P = t.charCodeAt(s + (c = a + 1)),
            R = t.charCodeAt(s + (p = a + 2)),
            E = t.charCodeAt(s + (d = a + 3)),
            f = a += 4,
            l = 0;
          l < me;
          l += 2
...
var Vo = {
  enabled:
    !Mo && $o == null && qo !== 'dumb' && ((ii != null && ii !== '0') || jo),
}
function F(e, r) {
...
var Bu = 100,
  ...
  Uo = Date.now(),
  Uu = 0,
  oi = typeof process < 'u' ? process.env : {}
  ...
  let r = {
    ...
    t = (...n) => {
      ...
      if (
        ...
        Kr.length > Bu && Kr.shift(),
        Yr.enabled(o) || i)
      ) {
        let l = n.map((c) => (typeof c == 'string' ? c : Qu(c))),
          u = `+${Date.now() - Uo}ms`
        ;(Uo = Date.now()),
    ...
    if (li(e)) {
      ...
      if (Array.isArray(e)) {
        ...
        if (o.length) {
          ...
          return (
            n.every((u, c) => be(u, s[c], t)) &&
            i.every((u, c) => be(u, a[c], t)) &&
            (o.length === 0 || be(o[0], l, t))
          )
        }
    ...
    [Oe]: () => ({
      match: (r) => {
        ...
        return (
          ...
          { matched: e.some((i) => be(i, r, n)), selections: t }
        )
      },
      getSelectionKeys: () => zr(e, Ge),
      matcherType: 'or',
...
var Be = (e) =>
  ...
  Ee = (e) =>
    Object.assign(pe(e), {
      between: (r, t) =>
        Ee(q(e, ((n, i) => A((o) => ye(o) && n <= o && i >= o))(r, t))),
  ...
  Ue = (e) =>
    Object.assign(pe(e), {
      between: (r, t) =>
        Ue(q(e, ((n, i) => A((o) => Ve(o) && n <= o && i >= o))(r, t))),
...
var pi = class e {
  ...
  with(...r) {
    ...
    let o = !1,
      ...
      l =
        !n.some((u) => be(u, this.input, a)) || (i && !i(this.input))
          ? ci
          : {
              matched: !0,
  ...
  when(r, t) {
    ...
    return new e(
      this.input,
      n ? { matched: !0, value: t(this.input, this.input) } : ci,
    )
  }
  otherwise(r) {
...
async function Zo() {
  ...
  let t = await ec(),
    n = await lc(),
    i = tc({ arch: r, archFromUname: n, familyDistro: t.familyDistro }),
    { libssl: o } = await nc(i)
...
async function ic(e) {
  try {
    return (await di.default.readdir(e)).find(
...
var Ht = {}
async function es() {
  if (oc(Ht)) return Promise.resolve({ ...Ht, memoized: !0 })
  let e = await Zo(),
    r = sc(e)
...
var zt = globalThis.window?.document !== void 0,
  hg = globalThis.process?.versions?.node !== void 0,
  yg = globalThis.process?.versions?.bun !== void 0,
  Eg = globalThis.Deno?.version?.deno !== void 0,
  bg = globalThis.process?.versions?.electron !== void 0,
  wg = globalThis.navigator?.userAgent?.includes('jsdom') === !0,
  xg =
...
var I = '\x1B[',
  ...
  uc = !zt && Zt.default.platform === 'win32',
  cc = zt
    ? () => {
        throw new Error(
  ...
  dc = (e, r) => {
    ...
    let t = ''
    return (
      e < 0 ? (t += I + -e + 'D') : e > 0 && (t += I + e + 'C'),
      r < 0 ? (t += I + -r + 'A') : r > 0 && (t += I + r + 'B'),
      t
    )
  },
  ns = (e = 1) => I + e + 'A',
  ...
  Ic = I + 'T',
  kc = '\x1Bc',
  Dc = uc ? `${fi}${I}0f` : `${fi}${I}3J${I}H`,
  Oc = I + '?1049h',
  _c = I + '?1049l',
  Nc = yr,
  Lc = (e, r) => [et, '8', Xr, Xr, r, yr, e, et, '8', Xr, Xr, yr].join(''),
  Fc = (e, r = {}) => {
  ...
  toString() {
    let { config: r } = this,
      t = r.provider.fromEnvVar
        ...
        : r.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: t, binaryTargets: Hc(r.binaryTargets) }),
      )
...
function hp(e, r, t) {
  ...
  if (n && r && i && sn.default.existsSync(r)) {
    let o = Mi.default.parse(sn.default.readFileSync(r)),
      s = []
...
m.inverseTangent = m.atan = function () {
  ...
  if (u.isFinite()) {
    ...
    if (p + 4 <= Bi) return (s = we(c, p + 4, d).times(0.5)), (s.s = u.s), s
  }
  for (
    c.precision = a = p + 10,
      c.rounding = 1,
  ...
  for (
    w = !1, r = Math.ceil(a / b), n = 1, l = u.times(u), s = new c(u), i = u;
    e !== -1;
  ...
  return (
    ...
    r > l.maxE + 1 || r < l.minE - 1
      ...
      : ((w = !1),
        ...
        (i = Ui(e.times(Je(a, n + t)), n)),
        i.d &&
          ((i = y(i, n + 5, 1)),
          at(i.d, n, o) &&
            ((r = n + 10),
            (i = y(Ui(e.times(Je(a, r + t)), r), r + 5, 1)),
            ...
            u < 0
              ? ((me = E[0]),
                ...
                u == -1 &&
                  ((D = E.length),
                  (u = r(_, E, H, D)),
                  u < 1 && (d++, t(E, H < D ? fr : _, D, l))),
                (D = E.length))
              : u === 0 && (d++, (E = [0])),
            (R[p++] = d),
            u && E[0] ? (E[D++] = K[V] || 0) : ((E = [K[V]]), (D = 1))
  ...
  e: if (r != null) {
    ...
    if (
      ...
      return (
        (p.length = 0),
        u
          ? ((r -= e.e + 1), (p[0] = U(10, (b - (r % b)) % b)), (e.e = -r || 0))
          : (p[0] = e.e = 0),
        e
      )
    if (
...
function Je(e, r) {
  ...
  if (
    ...
    ;(o = g.e),
      n > 1 ? ((g = new P('0.' + t)), o++) : (g = new P(n + '.' + t.slice(1)))
  } else
    return (
      (u = mn(P, c + 2, E).times(o + '')),
      (g = Je(new P(n + '.' + t.slice(1)), c - h).plus(u)),
      (P.precision = E),
      r == null ? y(g, E, R, (w = !0)) : g
    )
  for (
    p = g,
    ...
    if (
      ...
      if (
        ((l = l.times(2)),
        o !== 0 && (l = l.plus(mn(P, c + 2, E).times(o + ''))),
        (l = L(l, new P(f), c, 1)),
        r == null)
      )
        if (at(l.d, c - h, R, a))
...
function $p(e) {
  ...
  for (r = 0; r < o.length; r += 3)
    if (((t = o[r]), i && (this[t] = Vi[t]), (n = e[t]) !== void 0))
      if (X(n) === n && n >= o[r + 1] && n <= o[r + 2]) this[t] = n
      else throw Error(He + t + ': ' + n)
  if (((t = 'crypto'), i && (this[t] = Vi[t]), (n = e[t]) !== void 0))
    if (n === !0 || n === !1 || n === 0 || n === 1)
      if (n)
        if (
          typeof crypto < 'u' &&
...
var Cr = ((E) => (
  ...
  (E.updateManyAndReturn = 'updateManyAndReturn'),
  (E.upsert = 'upsert'),
  (E.delete = 'delete'),
...
var fd = (e) => e,
  ...
  v = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++gd }), e.__id
        )
      },
        ...
        for (let P = 0; P < S.length; ++P) {
          ...
          for (let V = n, te = i; V < r.length; te += r[V].length, ++V) {
            ...
            if (
              ...
              u != 1 && v.matchGrammar(e, r, t, V, te, !0, g),
              o)
            )
              break
          }
...
function xd(
  ...
  let l = Math.max(1, a.lineNumber - 3),
    u = bn.read(a.fileName)?.slice(l, a.lineNumber),
...
var Pn = (e) => e,
  Tn = { bold: Pn, red: Pn, green: Pn, dim: Pn, enabled: !1 },
...
function Md(e, r) {
  ...
  n && (n.getField(t)?.markAsError(), Jd(n, e.arguments)),
    r.addErrorMessage((i) =>
      ma(
        i,
        t,
  ...
  An = class {
    ...
    write(r) {
      ...
      this.hasError && t.underline().setColor(r.context.colors.red),
        r.write(t).write(Ea).write(this.value)
    }
  }
var Yi = class {
  arguments
...
var Lr = class {
  ...
  json(r) {
    return (
      Da(this._client), this._client._engine.metrics({ format: 'json', ...r })
    )
  }
}
function Oa(e, r) {
...
var eo = new WeakMap(),
  ...
  wt = class {
    constructor(r, t) {
      eo.set(this, { sql: r, values: t }),
        Object.defineProperty(this, Ln, { value: Ln })
    }
    get sql() {
...
var du = k(xi())
var mu = require('node:async_hooks'),
  fu = require('node:events'),
  gu = k(require('node:fs')),
  ei = k(require('node:path'))
var oe = class e {
  constructor(r, t) {
...
function qr(e = {}) {
  ...
  return Object.entries(r).reduce(
    (n, [i, o]) => (
      ja[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n
    ),
    { select: {} },
  )
}
...
var Wa = (e) => (Array.isArray(e) ? e : e.split('.')),
  oo = (e, r) => Wa(r).reduce((t, n) => t && t[n], e),
  Ja = (e, r, t) =>
    Wa(r).reduceRight(
      (n, i, o, s) => Object.assign({}, oo(e, s.slice(0, o)), { [i]: n }),
      t,
    )
function km(e, r) {
...
var Qm = () => globalThis.process?.release?.name === 'node',
  ...
  Jm = () => !!globalThis.Deno,
  Hm = () => typeof globalThis.Netlify == 'object',
  Km = () => typeof globalThis.EdgeRuntime == 'object',
  Ym = () => globalThis.navigator?.userAgent === 'Cloudflare-Workers'
function zm() {
  return (
    [
      [Hm, 'netlify'],
...
var ef = N('prisma:client:engines:resolveEnginePath'),
  rf = () => new RegExp('runtime[\\\\/]library\\.m?js$')
async function yl(e, r) {
  ...
  if (
    (ef('enginePath', n), n !== void 0 && e === 'binary' && Ti(n), n !== void 0)
  )
...
\`\`\``
      : '',
    c = (0,
    uo.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
var Wn = (e, r = new po()) => {
    let t = {
      ...
      startTransaction: async (...n) =>
        (await Me(r, e.startTransaction.bind(e))(...n)).map((o) => nf(r, o)),
    }
    return (
      e.getConnectionInfo &&
        (t.getConnectionInfo = of(r, e.getConnectionInfo.bind(e))),
      t
    )
  },
  nf = (e, r) => ({
...
var mo = 'This request could not be understood by the server',
  Rt = class extends $ {
    ...
    code = 'P5000'
    constructor(r, t, n) {
      super(t || mo, C(r, !1)), n && (this.code = n)
    }
  }
      ...
      this.startPromise !== void 0 && (await this.startPromise),
        (this.startPromise = (async () => {
          ...
          ;(this.host = t.host),
            ...
            (this.protocol = Ci(t) ? 'http' : 'https'),
            (this.remoteClientVersion = await Dl(this.host, this.config)),
            $t('host', this.host),
...
function ql({ copyEngine: e = !0 }, r) {
  ...
  let s = br(r.generator),
    a = s === 'library',
    l = s === 'binary',
    u = s === 'client'
  return i.accelerate
    ? new qt(r)
    : (i.driverAdapters, a ? new Gr(r) : (i.accelerate, new Gr(r)))
}
    ...
    (t) => {
      ...
      if (Fn(t))
        ...
        switch (r) {
          ...
          case 'mysql': {
            ;(n = t.sql),
              (i = { values: Qr(t.values), __prismaRawParameters__: !0 })
            break
          }
          case 'cockroachdb':
          case 'postgresql':
...
var Sf = wi.split('.')[0],
  ...
  Io = class {
    ...
    getGlobalTracingHelper() {
      let r = globalThis[`V${Sf}_PRISMA_INSTRUMENTATION`],
        ...
        (this.dataloader = new zn({
          batchLoader: ol(async ({ requests: n, customDataProxyFetch: i }) => {
            let { transaction: o, otelParentCtx: s } = n[0],
              ...
              u = n.some((p) => Do(p.protocolQuery.action))
            return (
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === 'itx' ? ru(n.transaction) : void 0,
...
function tu(e) {
  if (e.kind === 'Union') return { kind: 'Union', errors: e.errors.map(tu) }
...
var iu = [
  ...
  ou = ['pretty', 'colorless', 'minimal'],
  su = ['info', 'query', 'warn', 'error'],
  _f = {
...
var Mf = {
  ...
  $f = Symbol.for('prisma.client.transaction.id'),
  qf = {
    id: 0,
    nextId() {
      return ++this.id
  ...
  class r {
    ...
    constructor(n) {
      ...
      ;(this._extensions = Nr.empty()),
        ...
        (this._clientVersion = e.clientVersion ?? nu),
        (this._activeProvider = e.activeProvider),
        (this._globalOmit = n?.omit),
        (this._tracingHelper = Yl())
      let o = e.relativeEnvPaths && {
          rootEnvPath:
            e.relativeEnvPaths.rootEnvPath &&
            ei.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath &&
            ei.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s
      if (n?.adapter) {
        s = n.adapter
      ...
      let a =
        (!s && o && ot(o, { conflictCheck: 'none' })) || e.injectableEdgeEnv?.()
      try {
        let l = n ?? {},
          u = l.__internal ?? {},
          c = u.debug === !0
        ...
        gu.default.existsSync(p) || (p = e.dirname),
        ...
        if (
          ...
          (this._engine = ql(e, this._engineConfig)),
          (this._requestHandler = new Xn(this, i)),
          l.log)
        )
          for (let f of l.log) {
            let h =
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? Mf,
        ...
        l = async (u) => {
          ...
          if (c)
            return this._tracingHelper.runInChildSpan(s.middleware, (S) =>
              c(u, (P) => (S?.end(), l(P))),
            )
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new mu.AsyncResource('prisma-client-request').runInAsyncScope(() =>
          l(o),
        ),
      )
    }
