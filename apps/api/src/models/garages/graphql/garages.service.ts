...
import { Prisma, SlotType } from '../../../../generated/prisma'
...
export class GaragesService {
  ...
  async create({
    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      if (createSlots.count !== slotsByType.length) {
        throw new Error('Failed to create all slots.')
      }
  ...
  groupSlotsByType(
    ...
    const slotCounts: Record<SlotType, number> = {
      CAR: 0,
      HEAVY: 0,
      BIKE: 0,
      BICYCLE: 0,
